...
def main():
    ...
    while loop:
        ...
        if key == ord("l") or init:
            ...
            intersectP, nb_point_side1 = lp.find_all_intersection(final_img, line_tabP)
            ...
            print(
                "there is {} squares. {} in one side and {} in the other".format(
                    nb_square, nb_square_side1, nb_square_side2
                )
            )
